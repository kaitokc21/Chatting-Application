...
public class Client  implements ActionListener {
	...
	Client()
	{
		...
		ImageIcon i4 = new ImageIcon(ClassLoader.getSystemResource("ChatApp/icons/super_mario.png"));
		...
		b1.setBackground(new Color(7,84,94));
	...
	public void actionPerformed(ActionEvent ae) {
	 ...
	 public static void main(String[] args){
		    ...
		    while(true){
	            	...
	            	JPanel p2 = formatLabel1(msginput);
